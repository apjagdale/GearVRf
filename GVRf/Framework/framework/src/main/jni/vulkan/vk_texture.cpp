...
const VkImageView& VkTexture::getVkImageView()
{
    ...
    void VkTexture::updateMipVkImage(uint64_t texSize, std::vector<void *> &pixels,
    ...
    void VkTexture::createMipLevels(VkFormatProperties formatProperties, VulkanRenderer *vk_renderer,
